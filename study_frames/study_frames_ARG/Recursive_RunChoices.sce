...
// feature whether forcing data are not aggregated... check if it's working... to improve ?
...
if Alpha_BU <> []
    if Scenario == "" then
        error("No forcing available for alpha because no scenario selected");
    else
...
if Trade_BU <> []
    if Scenario == "" then
        error("No forcing available for trade because no scenario selected");
    else
...
if C_BU <> []
    if Scenario == "" then
        error("No forcing available for C because no scenario selected");
    else
