...
if (Scenario =="PMR_CP1"|Scenario =="PMR_CP2") & AGG_type== "AGG_PMR19"
	...
	if or(time_step==period_1)
		// CarbonTax_Diff_IC_p1 = [0.9, 0.9, 0.9, 0.9, 0.9, 1,0.9, 1, 0.9, 0.9 , 0.9 , 0.9, 0.9, 0.9, 0.9, 0.9, 1, 1, 1 ].*.ones(nb_Sectors,1);
	...
	if or(time_step==period_2)
		// CarbonTax_Diff_IC_p2 = [0.9, 0.9, 0.9, 0.9, 0.9, 1,0.9, 1, 0.9, 0.9 , 0.9 , 0.9, 0.9, 0.9, 0.9, 0.9, 1, 1, 1 ].*.ones(nb_Sectors,1);
