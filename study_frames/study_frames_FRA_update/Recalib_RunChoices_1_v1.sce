...
Deriv_Exogenous.Exo_GrossOpSurplus = 731.3390201809*1E6*0.96; 
...
//////////////////////////
// Unemployment rate 
parameters.u_param = 0.09
parameters.Coef_real_wage = 1.0;

// real GDP
parameters.Mu = 0.00;//0.0030318;
paramters.phi_L = parameters.Mu;

// Share of I in GDP
parameters.phi_K = -ones(parameters.phi_K)*0.00;//2;
