...
disp("FC : C, G, I, Y, X-M")
100*([sum(C.*pC) sum(G.*pG) sum(I.*pI) sum(Y.*pY) (sum(pM.*M) - sum(pX.*X))]*1E-6 - [1164.859 576.37 488.008 3894.637494 32.3017594])./[1164.859 576.37 488.008 3894.637494 32.3017594]
disp("NetLending")
