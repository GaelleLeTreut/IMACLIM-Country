...
test_fra_macro.VAR_sigma_omegaU = ['ademevalue','ref']
test_fra_macro.VAR_sigma_MX = ['ref'];
test_fra_macro.Spe_margs_Profit_margin_gaz_reduced = ['true'];
test_fra_macro.pY_ini_gaz_controlled_eco_eq = ['true'];
