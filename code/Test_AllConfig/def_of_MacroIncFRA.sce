...
test_fra_macro.VAR_Mu = ['neutral','low','high'];
test_fra_macro.VAR_saving = ['neutral','low','high'];
test_fra_macro.VAR_population = ['neutral','low','high'];
test_fra_macro.VAR_import_enersect = ['neutral'];
test_fra_macro.trade_drive = ['neutral','exports_detailed_low','exports_detailed_high'];
test_fra_macro.VAR_sigma_omegaU = ['ademevalue']
test_fra_macro.VAR_sigma_MX = ['neutral'];
