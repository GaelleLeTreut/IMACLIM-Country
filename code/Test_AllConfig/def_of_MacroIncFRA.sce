...
test_fra_macro.SystemOpt_Resol = ['SystemOpt_Static_neoclassical']
...
test_fra_macro.Scenario = ['AMErun3dgt', 'AMSrun3mix'];
...
test_fra_macro.VAR_sigma_M = ['ref'];
...
test_fra_macro.Proj_scenario = ['SNBC3_run3totalamsmixc2'];
test_fra_macro.Coef_real_wage_dashboard = ["1"];
