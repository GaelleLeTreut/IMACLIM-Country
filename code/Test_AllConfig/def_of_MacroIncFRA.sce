...
test_fra_macro.study = ['SNBC3_RunChoices4'];
...
test_fra_macro.Macro_nb = ['SNBC3_run3dgt'];
test_fra_macro.Scenario = ['AMS2026mesures'];
test_fra_macro.step = ['invest','menages','apu','kappa','lambda','alpha','exports_drive'];
test_fra_macro.proj_alpha = ['false'];
test_fra_macro.proj_kappa =  ['false'];
test_fra_macro.proj_lambda =  ['false'];
test_fra_macro.proj_invest =  ['false'];
test_fra_macro.proj_c =  ['false'];
test_fra_macro.exports_drive =  ['false'];
...
// test_fra_macro.VAR_sigma_omegaU = ["-3.6"];
