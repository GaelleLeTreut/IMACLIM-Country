...
test_fra_macro.SystemOpt_Resol = ['SystemOpt_Staticdemandles']
test_fra_macro.AGG_type = ['AGG_19TME'];
test_fra_macro.H_DISAGG = ['HH1'];
test_fra_macro.Nb_Iter = ['1'];
test_fra_macro.Macro_nb = ['neutral'];
test_fra_macro.Scenario = ['neutralpref'];
...
test_fra_macro.VAR_Mu = ['neutral'];
test_fra_macro.VAR_saving = ['neutral','low','high'];
test_fra_macro.VAR_population = ['neutral'];
test_fra_macro.VAR_import_enersect = ['neutral'];
test_fra_macro.trade_drive = ['neutral'];
test_fra_macro.VAR_sigma_omegaU = ['ref','-0.2','-0.3','-0.4','-0.5','-1.3','ademevalue']
test_fra_macro.VAR_sigma_MX = ['low'];
